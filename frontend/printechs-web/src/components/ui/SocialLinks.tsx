...
type SocialPlatform = (typeof siteConfig.social)[number]["platform"];
      ...
      {siteConfig.social.map((item) => (
        <li key={item.platform}>
          <a
            ...
            aria-label={`Follow Printechs on ${item.label}`}
            className={`inline-flex h-10 w-10 items-center justify-center rounded-sm border border-paper/15 text-paper/70 transition duration-300 ease-premium hover:border-paper/35 hover:bg-paper/10 hover:text-paper focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-signal ${iconButtonClassName}`}
          >
