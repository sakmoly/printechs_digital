...
export type ProductPageContent = {
  ...
  keyFeatures?: Array<{ title: string; description: string; icon?: ProductIconKey }>;
  connectionHeading?: string;
  connectionCenterLabel?: string;
  connectionItems?: Array<{ title: string; href?: string | null }>;
  processHeading?: string;
  processSubheading?: string;
  processSteps?: Array<{ groupTitle: string; title: string; description?: string | null }>;
  localizationHeading?: string;
  localizationBody?: string;
  localizationChips?: string[];
  reportsHeading?: string;
  reportsImage?: MediaAsset;
  reportItems?: string[];
  dashboardHeading?: string;
  dashboardBody?: string;
  dashboardImage?: MediaAsset;
  audienceHeading?: string;
  audienceItems?: Array<{ title: string; description?: string | null }>;
  integrationHeading?: string;
  implementationHeading?: string;
  implementationCta?: Cta;
  finalCta?: {
    heading: string;
    description: string;
    primary?: Cta;
